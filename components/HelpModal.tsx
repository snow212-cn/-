        ...
        <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 text-game-text text-xs sm:text-sm leading-relaxed">
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-game-muted">
              ...
              <li><strong className="text-game-text">突破</strong>：武学每到 x9 级（如 99, 109）需要闭关。</li>
              <li><strong className="text-game-text">主/副武学</strong>：主武学提供 100% 真元，副武学提供 50% 真元。</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2 text-game-muted">
              ...
              <li>
                ...
                <span className="inline-block w-2 h-2 rounded-full bg-red-500 mx-1"></span> 红色越深，代表当前等级提升十级后每小时获得真元越多。
